...
LIBRARIES="-lwiringPi -lm -lasound -lpthread -lNeoPixelRPi -lwiringPiMCP23x17rpi"
...
executable() {
  ...
  userEcho $CC $INCLUDES $LIBRARIES $LDFLAGS src/merlin.cpp  -o $BIN/merlin lib/libMerlin.a
}
